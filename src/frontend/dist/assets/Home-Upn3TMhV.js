import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useActor, a as useQuery, b as createActor, d as useLanguage, P as Phone, M as MessageCircle, L as Link, e as MapPin, S as ShieldCheck, f as Package } from "./index-DIjz4Rf9.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[oklch(0.12_0.06_35/0.70)] via-transparent to-transparent" })
            ]
          }
        ),
        slide.title && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 px-4 pb-4 pt-8 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
          ...
          "div",
          {
            ...
            children: slides.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `rounded-full transition-all duration-200 ${i === current ? "w-5 h-2 bg-secondary" : "w-2 h-2 bg-[oklch(0.97_0.04_80/0.55)] hover:bg-[oklch(0.97_0.04_80/0.80)]"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: featuredProducts.length === 0 ? [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                const imageSrc = product.imageIds[0] || (catEntry == null ? void 0 : catEntry.image) || "/assets/generated/hero-clay-idols.dim_1200x600.jpg";
