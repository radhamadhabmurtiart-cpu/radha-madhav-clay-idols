import { u as useLanguage, j as jsxRuntimeExports, L as Link, r as reactExports } from "./index-DBsV3H2z.js";
import { B as BookOpen, C as Calendar } from "./calendar-CyFmIdRf.js";
...
function BlogListPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-muted/30 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-3xl mx-auto px-4 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: t({
