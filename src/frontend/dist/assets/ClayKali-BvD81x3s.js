...
const config = {
  ...
  metaDescription: "Order handmade clay Kali idols wholesale for Kali Puja & Diwali. Bulk supply to puja committees & shops in Bardhaman, Kolkata, Asansol, Durgapur & all India.",
  ...
  descBn: "আমাদের মাটির কালী মূর্তি দক্ষ শিল্পীদের হাতে তৈরি — কালী পূজা ও শ্যামা পূজার জন্য আদর্শ। বর্ধমান, কলকাতা, দুর্গাপুর সহ সারা ভারতে পাইকারি সরবরাহ। বাল্ক অর্ডার গ্রহণযোগ্য।",
  altTexts: [
