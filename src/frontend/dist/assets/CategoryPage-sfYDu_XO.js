import { r as reactExports, j as jsxRuntimeExports, S as ShieldCheck, g as Skeleton, d as useLanguage, L as Link } from "./index-CyyY0WO7.js";
import { B as Breadcrumb } from "./Breadcrumb-Caia5x4z.js";
import { a as useProductsByCategory } from "./useProducts-PFbqUxMn.js";
import { S as Star } from "./star-CocbqdQZ.js";
import { T as Truck } from "./truck-DsDv7DXy.js";
    ...
    "article",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 sm:p-4 space-y-2 flex flex-col flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/products/$productId",
              params: { productId: product.slug },
...
function CategoryPage({ config }) {
  ...
  const filteredProducts = backendProducts && backendProducts.length > 0 ? backendProducts.map((p, i) => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ProductsGridSkeleton, {}) : filteredProducts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-sm mx-auto", children: "We are adding product photos and pricing. Contact us directly for current availability and bulk pricing." })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary/10 border-t border-primary/20 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl mx-auto px-4 text-center space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-primary text-lg", children: "+91 6295466310" })
    ] }) }),
