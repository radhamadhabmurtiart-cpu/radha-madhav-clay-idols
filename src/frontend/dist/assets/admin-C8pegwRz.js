import { r as reactExports, j as jsxRuntimeExports, R as React, F as composeRefs, H as reactDomExports } from "./index-DOyg_51M.js";
...
function formDataToAddInput(data) {
  return {
...
function formDataToUpdateInput(id, data) {
  return {
    id,
