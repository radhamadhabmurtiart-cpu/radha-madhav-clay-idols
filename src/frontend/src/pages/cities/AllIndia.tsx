...
const WHATSAPP_LINK =
  "https://wa.me/916295466310?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20all-India%20bulk%20clay%20idol%20orders.";
...
export function CityAllIndiaPage() {
  const { t } = useLanguage();

  useEffect(() => {
    document.title =
      "Clay Idol Wholesale Supplier All India | সারা ভারতে মাটির মূর্তি পাইকারি – Radha Madhav Shilpalay";
  ...
  // Inject schemas: LocalBusiness + ServiceArea (India) + FAQ
  useEffect(() => {
    ...
    const schemas = [
      {
        ...
        description:
          "Pan-India clay idol manufacturer and wholesaler based in Bardhaman, West Bengal. Supplying handmade Durga, Ganesh, Lakshmi, Saraswati, Kali and Hanuman idols across India for Bengali diaspora communities, puja committees, and temple trusts.",
        priceRange: "₹₹",
        areaServed: {
          "@type": "Country",
          name: "India",
      ...
      },
      {
        ...
        description:
          "Wholesale supply of handmade clay idols across all Indian states. Safe packaging, railway parcel and road transport options available for long-distance delivery.",
      },
      {
        "@context": "https://schema.org",
        "@type": "FAQPage",
  ...
  return (
    <>
        ...
        <div className="relative z-10 container max-w-4xl mx-auto px-4">
          ...
          <div className="inline-flex items-center gap-2 bg-secondary/20 border border-secondary/40 rounded-full px-4 py-1.5 mb-5">
            ...
            <span className="text-xs font-semibold text-secondary uppercase tracking-widest">
              {t({ bn: "সারা ভারতে সরবরাহ", en: "Pan-India Delivery" })}
            </span>
          </div>
        ...
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-widest text-secondary mb-2">
              {t({ bn: "প্রধান শহরে সরবরাহ", en: "Serving Major Cities" })}
            </p>
            <h2 id="metros-heading" className="text-display-sm text-foreground">
              {t({
      ...
      {/* ─── Logistics Trust ─── */}
      <section className="py-12 bg-background" aria-label="Logistics Trust">
        <div className="container max-w-5xl mx-auto px-4">
